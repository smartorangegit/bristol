...
<html lang="uk">
  <head>
    ...
    <title>ЖК BRISTOL Comfort House - дозвільна документація</title>
    ...
    <meta name="description" content="ЖК BRISTOL Comfort House - дозвільна документація. Відділ продажу: ☎ (044) 22 77 144, м.Київ, впр-т В. Лобановського,146-б">
  ...
  <body>
    ...
    <div class="section_one documentation">
      <div class="docs_wrapper">
        <h1 class="ten_name">Дозвільна документація</h1>
        <div class="doc__box">

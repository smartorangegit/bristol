...
<script>
    ...
    var myCallBack = function() {
        ...
        var element=document.getElementById('reCaptcha3');
        if(!element){} else {
...
<div class="header_wrapper">
  <div class="round-block nomobile" style="background-color:#E3222C;"><a href="/ru/">
	...
	<div class="wowoo yesmobile"><a class="wowoo-link" href="#" id="phone_mob"><?php/*<img src="/img/icons/big_tel.png">*/?><span id="tel_tel">(044) 22-77-144</span></a></div>
      <div class="header-top">
        <div class="header-content">
          ...
          <? /* Рингостат заменяет всю строку и присылает укр верисю тектса dummy_text нанесен поверх */?>
          <div class="dummy_text">Отдел продаж:</div>
          ...
          <div class="mini-menu">
            <ul>
              ...
              <li>
                ...
                <div class="adress">Проспект В. Лобановского, 146Б</div>
                <div class="mail">info@bristol.house
                  ​​​​​​​​</div>
              </li>
            </ul>
          </div>

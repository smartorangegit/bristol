...
<div id="one_callback" class="one_callback">
  ...
  <form class="one" action="/application.php" method=post enctype="multipart/form-data">
    ...
    <div class="not" id="reCaptcha1" style="margin-top:0; margin-left:60px;" ></div>
  </form>
</div>
...
<div class="webcamera nomobile"><a href="/webcam/">Веб-камера</a></div>
<?php
...
<div class="header_wrapper" style="z-index:999;">
  <div class="round-block nomobile"><a href="/"></a></div>
    <div class="header">
	<div class="wowoo yesmobile"><a class="wowoo-link" href="#" id="phone_mob"><?php/*<img src="/img/icons/big_tel.png">*/?><span id="tel_tel">(044) 22-77-144</span></a></div>
      <div class="header-top">
        <div class="header-content">
          <div class="lang">
            <a href="<?php if(!empty($url_a)){ echo $url_a;}else{ echo $uRa;}?>">Укр</a>
            <a href="<?php if(!empty($url_r)){ echo $url_r;}else{ echo $uRr;}?>">Рус</a>
            <!-- <a href="#">Eng</a> -->
          </div>
          <div class="nav-logo yesmobile"><a href="/"><img src="/img/logo/bristol.svg" alt=""></a></div>
          <div class="sale nomobile" id="phone_ring">Відділ продажу: (044) 22-77-144</div>
          <div class="webcam yesmobile"><a href="/webcam/">Веб-камера</a></div>
 ...
 $(window).on('onload resize', mob_phone_replace);
        ...
        <div class="nav-mini yesmobile">
          ...
          <div class="mini-menu">
            <ul>
              ...
              <li><a href="/#search">будинок</a></li>
              <li><a href="/#map">розташування</a></li>
              <li><a href="/#cause">переваги</a></li>
              <li><a href="/flats/">квартири</a></li>
        ...
        <div class="nav_wrapper">
          ...
          <div class="nav-right nomobile">
            <ul>
              ...
              <li style="margin: 0 0 0 8px;"><a href="#">контакти</a></li>
    ...
    <div class="nav-mask">
      <svg  xmlns:dc="https://purl.org/dc/elements/1.1/"  xmlns:cc="https://creativecommons.org/ns#"  xmlns:rdf="https://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="https://www.w3.org/2000/svg"  xmlns="https://www.w3.org/2000/svg" xmlns:sodipodi="https://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd"
        ...
        <defs id="defs3381" />
        <a xlink:href="/#search"><polygon id="XMLID_180_" class="st0"  points="1990,317.3 1990,201.3 2168.8,201.3 2168.8,355.3 "transform="translate(-630,-51.499997)" /></a>
        <a xlink:href="/#map"><polygon id="XMLID_181_" class="st0" points="2206.6,363.3 2168.8,355.3 2168.8,201.3 2435.2,201.3 2435.2,328.1 2386.2,314.1 " transform="translate(-630,-51.499997)" /></a>
        <a xlink:href="/#cause"><polygon id="XMLID_190_" class="st0" points="2435.2,328.1 2582.8,370.5 2624.5,361.3 2624.5,201.3 2435.2,201.3 " transform="translate(-630,-51.499997)" /></a>
        <a xlink:href="/flats/"><polygon id="XMLID_186_" class="st0" points="2624.5,201.3 2833.8,201.3 2833.8,321.5 2624.5,361.3 " transform="translate(-630,-51.499997)" /></a>
        <a xlink:href="/#builder"><polygon id="XMLID_192_" class="st0" points="3449.2,314.8 3449.2,201.3 3218.5,201.3 3218.5,345.5 3309.3,361.3 " transform="translate(-630,-51.499997)" /></a>
        <a xlink:href="/build/"><polygon id="XMLID_191_" class="st0" points="3449.2,314.8 3684.5,350.3 3684.5,201.3 3449.2,201.3 " transform="translate(-630,-51.499997)" /></a>
        <a xlink:href="/contact/"><polygon id="XMLID_193_" class="st0" points="3684.5,350.3 3848.5,375 3848.5,201.3 3684.5,201.3 " transform="translate(-630,-51.499997)" /></a>
        <a xlink:href="/news/"><polygon id="XMLID_194_" class="st0" points="3848.5,375 4011.8,351.7 4011.8,201.3 3848.5,201.3 " transform="translate(-630,-51.499997)" /></a>
      </svg>

...
<html>
  <head>
    ...
    <title>Планировка и технические характеристики квартиры <?= '2Г-' . str_replace('/', '', $get_fool); ?> - ЖК BRISTOL Comfort House</title>
    <meta name="description" content="ЖК BRISTOL Comfort House - план и характеристики квартиры <?= '2Г-' . str_replace('/', '', $get_fool); ?>. Выберите свою квартиру в центре Киева на пр-т В. Лобановського, 146Б">
...
<input  name="inn" class="userInn" type="hidden" value="Bristol"/>
          ...
          <div class="one_text_left wow bounceInRight">
            <p>2-комнатная квартира. Тип 2Г.</p>
          </div>
            <div class="flat_datailed plan2g_data_datailed">
            <div style="height: 99%;!important">
              <div style="height: 99%;!important">
              ...
              <aside>
                <aside calss="collum">
                  ...
                  <p>Прихожая:<span>9,77</span></p>
                  <p>Гостинная:<span>18,16</span></p>
		              <p>Спальня:<span>17,01</span></p>
                  <p>Санузел:<span>8,75</span></p>
                  <p>Туалет:<span>3,59</span></p>
                  <p>Лоджия:<span>3,75*0,5</span></p>
                </aside>
                <aside calss="collum">
                  <p>Площадь:<span>м</span></p>
                  <p>Жилая:<span>35,17</span></p>
                  <p>Общая:<span>72,17</span></p>
          ...
          <a href="/ru/selection_flats.php?id=<?php if(empty($get_fool)){echo '1';}else{echo $get_fool;}?>" class="reserve long plan2g_all_apartments"><span>‹‹ </span> Смотреть все квартиры</a>
          <a href="/ru/flats/" class="reserve plan2g_choose_floor"><span>‹‹ </span> Выбрать этаж</a>

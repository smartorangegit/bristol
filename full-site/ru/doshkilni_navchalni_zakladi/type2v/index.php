...
<html>
  <head>
    ...
    <title>Планировка и технические характеристики квартиры <?= '2В-' . str_replace('/', '', $get_fool); ?> - ЖК BRISTOL Comfort House</title>
    <meta name="description" content="ЖК BRISTOL Comfort House - план и характеристики квартиры <?= '2В-' . str_replace('/', '', $get_fool); ?>. Выберите свою квартиру в центре Киева на пр-т В. Лобановського, 146Б">
...
<input  name="inn" class="userInn" type="hidden" value="Bristol"/>
          ...
          <div class="one_text_left wow bounceInRight">
            <p>2-комнатная квартира. Тип 2В.</p>
          </div>
            ...
            <div>
              ...
              <aside>
                <aside calss="collum">
                  ...
                  <p>Прихожая:<span>12,53</span></p>
                  <p>Гостинная:<span>18,01</span></p>
                  <p>Спальня:<span>14,47</span></p>
                  <p>Санузел:<span>3,66</span></p>
                  <p>Туалет:<span>2,98</span></p>
                  <p>Балкон:<span>3.73*0,5</span></p>
                </aside>
                <aside calss="collum">
                  <p>Площадь:<span>м</span></p>
                  <p>Жилая:<span>32,46</span></p>
                  <p>Общая:<span>70,17</span></p>
          ...
          <a href="/ru/selection_flats.php?id=<?php if(empty($get_fool)){echo '1';}else{echo $get_fool;}?>" class="reserve long plan2v_all_apartments"><span>‹‹ </span> Смотреть все квартиры</a>
          <a href="/ru/flats/" class="reserve plan2v_choose_floor"><span>‹‹ </span> Выбрать этаж</a>

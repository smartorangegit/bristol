...
<html>
  <head>
    ...
    <title>Планировка и технические характеристики квартиры <?= '1Б-' . str_replace('/', '', $get_fool); ?> - ЖК BRISTOL Comfort House</title>
    <meta name="description" content="ЖК BRISTOL Comfort House - план и характеристики квартиры <?= '1Б-' . str_replace('/', '', $get_fool); ?>. Выберите свою квартиру в центре Киева на пр-т В. Лобановського, 146Б">
...
<input  name="inn" class="userInn" type="hidden" value="Bristol"/>
          ...
          <div class="one_text_left wow bounceInRight">
            <p>1-комнатная квартира. Тип 1Б.</p>
          </div>
          ...
          <a href="/ru/selection_flats.php?id=<?php if(empty($get_fool)){echo '1';}else{echo $get_fool;}?>" class="reserve long plan1b_all_apartments"><span>‹‹ </span> Сметреть все квартиры</a>
          <a href="/ru/flats/" class="reserve plan1b_choose_floor"><span>‹‹ </span> Выбрать этаж</a>
          <img src="/map/1b.png" alt="">

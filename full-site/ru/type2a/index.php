...
<html>
  <head>
    ...
    <title>Планировка и технические характеристики квартиры <?= '2А-' . str_replace('/', '', $get_fool); ?> - ЖК BRISTOL Comfort House</title>
    <meta name="description" content="ЖК BRISTOL Comfort House - план и характеристики квартиры <?= '2А-' . str_replace('/', '', $get_fool); ?>. Выберите свою квартиру в центре Киева на пр-т В. Лобановського, 146Б">
...
<input  name="inn" class="userInn" type="hidden" value="Bristol"/>
          ...
          <div class="one_text_left wow bounceInRight">
            <p>2-комнатная квартира. Тип 2А.</p>
          </div>
            ...
            <div>
              ...
              <aside>
                <aside calss="collum">
                  ...
                  <p>Прихожая:<span>16,39</span></p>
                  <p>Гостинная:<span>19,26</span></p>
                  <p>Спальня:<span>16,68</span></p>
                  <p>Санузел:<span>4,87</span></p>
                  <p>Туалет:<span>2,17</span></p>
                  <p>Лоджия:<span>4.48*0,5</span></p>
                </aside>
                <aside calss="collum">
                  <p>Площадь:<span>м</span></p>
                  <p>Жилая:<span>35,94</span></p>
                  <p>Общая:<span>81,04</span></p>
          ...
          <a href="/ru/selection_flats.php?id=<?php if(empty($get_fool)){echo '1';}else{echo $get_fool;}?>" class="reserve long plan2a_all_apartments"><span>‹‹ </span> Сметреть все квартиры</a>
          <a href="/ru/flats/" class="reserve plan2a_choose_floor"><span>‹‹ </span> выбрать этаж</a>

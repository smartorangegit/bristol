...
<html>
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
	  <link rel="icon" href="http://bristol.house/mt-content/uploads/2016/10/cimvol.png" type="image/png" />
    <title>SELECT</title>
    ...
    <div class="section_one rooms flat">
      ...
      <div class="wrapper clearfix" style="height:100%;">
        ...
        <div class="appart_left">
              ...
              <div class="floor_info">
                <div><?echo $_GET['id'];?><br><p>Поверх</p></div>
              </div>
              <a href="http://138.201.178.152/flats.html" class="button"><span>‹‹ </span> Обрати поверх</a>
        </div>
      ...
      <div class="appart_right">
        <div class="appart_right_img">
          ...
          <a  class="flat1" xlink:href="type.php">
          ...
          <a  class="flat2" xlink:href="type.php">
          ...
          <a  class="flat3" xlink:href="type.php">
          ...
          <a  class="flat4" xlink:href="type.php">
          ...
          <a  class="flat5" xlink:href="type.php">
          ...
          <a  class="flat6" xlink:href="type.php">
          ...
          <a  class="flat7" xlink:href="type.php">
              ...
              <div class="flat_datailed datailed_1">
                  <div>
                    <div>
                      ...
                      <p>Поверх: 2-25</p>
                      <a href="http://138.201.178.152/type.html" class="reserve">Переглянути</a>
                    </div>
                  </div>
                </div>

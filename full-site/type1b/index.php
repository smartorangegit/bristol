...
<html>
  <head>
    ...
    <title>Планування і технічні характеристики квартири <?= '1Б-' . str_replace('/', '', $get_fool); ?> - ЖК BRISTOL Comfort House</title>
    <meta name="description" content="ЖК BRISTOL Comfort House - план і характеристики квартири <?= '1Б-' . str_replace('/', '', $get_fool); ?>. Оберіть свою квартиру в центрі Києва на пр-т В. Лобановського, 146Б">
...
<input  name="inn" class="userInn" type="hidden" value="Bristol"/>
          ...
          <div class="one_text_left wow bounceInRight">
            <p>1-кімнатна квартира. Тип 1Б.</p>
          </div>
            ...
            <div>
              ...
              <aside>
                <aside calss="collum">
                  ...
                  <p>Передпокій:<span>11,90</span></p>
                ...
                <aside calss="collum">
                  <p>Площа:<span>м</pan></p>
                  <p>Житлова:<span>18,83</span></p>
                  <p>Загальна:<span>49,59</span></p>
          ...
          <a href="/selection_flats.php?id=<?php if(empty($get_fool)){echo '1';}else{echo $get_fool;}?>" class="reserve long plan1b_all_apartments"><span>‹‹ </span> Дивитися всі квартири</a>
          <a href="/flats/" class="reserve plan1b_choose_floor"><span>‹‹ </span> Обрати поверх</a>
          <img src="/map/1b.png" alt="plan">

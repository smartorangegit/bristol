...
<html>
  <head>
    ...
    <title>Планування і технічні характеристики квартири <?= '2Б-' . str_replace('/', '', $get_fool); ?> - ЖК BRISTOL Comfort House</title>
    <meta name="description" content="ЖК BRISTOL Comfort House - план і характеристики квартири <?= '2Б-' . str_replace('/', '', $get_fool); ?>. Оберіть свою квартиру в центрі Києва на пр-т В. Лобановського, 146Б">
...
<input  name="inn" class="userInn" type="hidden" value="Bristol"/>
          ...
          <div class="one_text_left wow bounceInRight">
            <p>2-кімнатна квартира. Тип 2Б.</p>
          </div>
            ...
            <div>
              ...
              <aside>
                <aside calss="collum">
                  ...
                  <p>Кухня:<span>15,18</span></p>
                  <p>Передпокій:<span>14,62</span></p>
                  <p>Вітальня:<span>19,36</span></p>
                  <p>Спальня:<span>15,36</span></p>
                  <p>Санвузол:<span>3,94</span></p>
                  <p>Туалет:<span>1,85</span></p>
                  <p>Балкон:<span>4.43*0,3</span></p>
                </aside>
                <aside calss="collum">
                  <p>Площа:<span>м</span></p>
                  <p>Житлова:<span>34,72</span></p>
                  <p>Загальна:<span>71,67</span></p>
          ...
          <a href="/selection_flats.php?id=<?php if(empty($get_fool)){echo '1';}else{echo $get_fool;}?>" class="reserve long plan2b_all_apartments"><span>‹‹ </span> Дивитися всі квартири</a>
          <a href="/flats/" class="reserve plan2b_choose_floor"><span>‹‹ </span> Обрати поверх</a>
          <img src="/map/2b.png" alt="">

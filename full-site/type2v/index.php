...
<html>
  <head>
    ...
    <title>Планування і технічні характеристики квартири <?= '2В-' . str_replace('/', '', $get_fool); ?> - ЖК BRISTOL Comfort House</title>
    <meta name="description" content="ЖК BRISTOL Comfort House - план і характеристики квартири <?= '2В-' . str_replace('/', '', $get_fool); ?>. Оберіть свою квартиру в центрі Києва на пр-т В. Лобановського, 146Б">
...
<?php include '../include/gtm.php';?>
    <div class="section_one rooms type type2v_section_one">
...
<input  name="inn" class="userInn" type="hidden" value="Bristol"/>
          ...
          <div class="one_text_left wow bounceInRight">
            <p>2-кімнатна квартира. Тип 2В.</p>
          </div>
            <div class="flat_datailed plan2v_data_datailed">
            <div>
              ...
              <aside>
                <aside calss="collum">
                  ...
                  <p>Кухня:<span>17,26</span></p>
                  <p>Передпокій:<span>12,53</span></p>
                  <p>Вітальня:<span>18,01</span></p>
                  <p>Спальня:<span>14,47</span></p>
                  <p>Санвузол:<span>3,66</span></p>
                  <p>Туалет:<span>2,98</span></p>
                  <p>Балкон:<span>4.19*0,3</span></p>
                </aside>
                <aside calss="collum">
                  <p>Площа:<span>м</span></p>
                  <p>Житлова:<span>32,46</span></p>
                  <p>Загальна:<span>70,17</span></p>
          ...
          <a href="/selection_flats.php?id=<?php if(empty($get_fool)){echo '1';}else{echo $get_fool;}?>" class="reserve long plan2v_all_apartments"><span>‹‹ </span> Дивитися всі квартири</a>
          <a href="/flats/" class="reserve plan2v_choose_floor"><span>‹‹ </span> Обрати поверх</a>
          <img src="/map/2v.png" alt="">
